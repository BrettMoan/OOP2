...

{
    ...
    static{
        ...
        config.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:8889/brettmoa_test");

        //change the next two lines of code to match your MySQL user name and password.

        config.setProperty("hibernate.connection.username", "hibernate_test");

        config.setProperty("hibernate.connection.password", "hibernate_test");
