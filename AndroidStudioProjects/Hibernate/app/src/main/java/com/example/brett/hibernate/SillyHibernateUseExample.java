package com.example.brett.hibernate;
/*
...
import com.java.life.real.examples.HibernateUtilSingleton;
import com.java.life.real.examples.User;
import com.java.life.real.examples.PhoneNumber;
...
public class SillyHibernateUseExample
{
    ...
    private void addNewUsers() {
          HibernateUtilSingleton.getSessionFactory();
//        HibernateUtilSingleton hus = new HibernateUtilSingleton();
